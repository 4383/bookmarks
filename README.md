...
- [Docker + rocker](https://github.com/grammarly/rocker)
- [Docker base](http://linuxfr.org/news/docker-tutoriel-pour-manipuler-les-conteneurs)
- [Docker ecosystem](https://github.com/emilevauge/awesome-docker)
...
- [Docker ip](http://networkstatic.net/10-examples-of-how-to-get-docker-container-ip-address/)
- [Docker bind dns](https://www.damagehead.com/blog/2015/04/28/deploying-a-dns-server-using-docker/)
...
- [Multi auth with redis session storage](http://michal.karzynski.pl/blog/2013/07/14/using-redis-as-django-session-store-and-cache-backend/)
- [Api auth best practices](http://blog.ineat-conseil.fr/2013/01/restful-authentication/)
- [Service discovery](https://www.consul.io/)
- [Docker orchestration](http://kubernetes.io/)
...
The python programming language links (articles, changelogs, etc...)

[Get python links](sections/python.md)
...
- [Microservices security](http://www.grahamlea.com/2015/07/microservices-security-questions/)
- [Mapping the www](https://reflets.info/le-monde-selon-telegram/)
- [Online scanner](https://hackertarget.com/)
- [System and service search engine like shodan](https://censys.io/)
- [Docker security](http://www.dennyzhang.com/docker_bench_security/?mkt_tok=eyJpIjoiTWpBek5tSXlOakZoTlRRMiIsInQiOiJXWmcycEp0ZEF5dlJJUTd4V0hZN2ZhczFPbng2OUlvZHExU2JFVHcwRTVid2pQUjhNZjJNRjFoWTNhYUxJNkl3ZzZnMnEwM3ppRjdlYjduSmxJbTFxZmtkUngyNTBBZUZaQXM4dXJOT2didz0ifQ%3D%3D)
...
- [Facebook bug bounty list](https://www.facebook.com/notes/phwd/facebook-bug-bounties/707217202701640)
- [Certificats ssl gratuit](https://letsencrypt.org/getting-started/)
- [Letsencrypt aws](https://www.paulwakeford.info/2015/11/24/letsencrypt/)
- [Masquer topologie](https://fr.wikipedia.org/wiki/Principe_de_Kerckhoffs)
- [Sécurité des développements](http://www.opensamm.org/explore/)
- [Quine](http://blog.rom1v.com/2011/11/programmes-auto-reproducteurs-quines/)
- [Api auth best practices](http://blog.ineat-conseil.fr/2013/01/restful-authentication/)
- [Mode op](http://pastebin.com/kHUzWWm9)
